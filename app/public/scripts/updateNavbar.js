    ...
    if (online.statusCode === 200) {
        ...
        <nav class="navbar navbar-expand-lg bg-primary">
          <div class="container-fluid d-flex">
            ...
            <div class="navbar-nav">
                <a class="nav-link" href="../index.html" id="products">Products</a>
                <a class="nav-link" href="../pages/profile.html" id="profile">Profile</a>
                <a class="nav-link" href="../pages/cart.html" id="cart">Cart</a>
        ...
        document.querySelector("#signout").onclick = async () => {
          ...
          if (response.statusCode === 200) {
            ...
            console.error("error en el cierre de sesion");
          }
        };
    } else {
        template = `
